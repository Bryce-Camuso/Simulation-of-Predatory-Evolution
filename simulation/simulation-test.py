...
def movementCycle1(predator, prey, plants, map, phase, preyEating = False, debug = False):
    ...
    # translation graph https://www.desmos.com/calculator/yibab5wknk if it stays 60 switch graph back.
    ...
    scentCountDownMax = 20 # will update 3 times per movement cycle
